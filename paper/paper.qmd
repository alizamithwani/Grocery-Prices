...
subtitle: "We compare each product's price data for each vendor over time."
author: 
  - Talia Fabregas
  - Lexi Knight
  - Fatimah Yunusa
...
The remainder of this paper is structured as follows: @sec-data presents the methods used to analyze grocery prices , followed by @sec-results, which details our findings. @sec-discussion shows a discussion of the findings, limitations and suggestions for future research directions.
...
We used R (@citeR) to write this paper and all data manipulation/analysis was done using SQL (@sqldf).
